...
# --------------------------------------------------------------------------- #
#  Reusable commands (shared by this module's main() and trainbot.py)
# --------------------------------------------------------------------------- #
    ...
    if lock.exists():
        ...
        if old and old != os.getpid() and _pid_alive(old):
            raise SystemExit(
                ...
                f"at a time — stop it (python agents/vla-trainbot/trainbot.py stop, or kill PID {old}) or "
...
def run_cli(args) -> None:
    """Dispatch a parsed run-args namespace (used by main() and trainbot.py 'run')."""
