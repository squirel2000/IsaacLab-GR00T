...
source "${ROOT_DIR}/paths.env"
ISAACLAB_DIR="${WS_ISAACLAB}"
...
DATASET_DIR="${DATASET_DIR:-${WS_DATASETS}/g1_cabinet_pour}"
...
OUTPUT_DATASET_DIR="${OUTPUT_DATASET_DIR:-${WS_DATASETS}/G1_Inspire_Cabinet_Pour_Dataset}"
